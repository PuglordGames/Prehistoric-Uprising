...
import net.mcreator.prehistoricuprising.entity.model.ParasaurolophusModel;
...
public class ParasaurolophusRenderer extends GeoEntityRenderer<ParasaurolophusEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, ParasaurolophusEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
