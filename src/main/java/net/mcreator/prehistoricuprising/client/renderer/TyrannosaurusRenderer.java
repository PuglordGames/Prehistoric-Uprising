...
import net.mcreator.prehistoricuprising.entity.model.TyrannosaurusModel;
...
public class TyrannosaurusRenderer extends GeoEntityRenderer<TyrannosaurusEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, TyrannosaurusEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
