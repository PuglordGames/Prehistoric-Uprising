...
public class ExtractorGUIScreen extends AbstractContainerScreen<ExtractorGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("prehistoric_uprising:textures/screens/extractor_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.prehistoric_uprising.extractor_gui.label_cleaner"), 69, 7, -12829636, false);
	}
