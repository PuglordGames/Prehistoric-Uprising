 ...
 *
 */
package net.mcreator.prehistoricuprising;
...
@Mod("prehistoric_uprising")
public class PrehistoricUprisingMod {
	public static final Logger LOGGER = LogManager.getLogger(PrehistoricUprisingMod.class);
	public static final String MODID = "prehistoric_uprising";
