...
public class TyrannosaurusEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(TyrannosaurusEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(TyrannosaurusEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(TyrannosaurusEntity.class, EntityDataSerializers.STRING);
	...
	public TyrannosaurusEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PrehistoricUprisingModEntities.TYRANNOSAURUS.get(), world);
	}

	public TyrannosaurusEntity(EntityType<TyrannosaurusEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "tyrannosaurus");
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, EdmontosaurusEntity.class, true, true));
		this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, TriceratopsEntity.class, true, true));
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		TyrannosaurusEntity retval = PrehistoricUprisingModEntities.TYRANNOSAURUS.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(PrehistoricUprisingModEntities.TYRANNOSAURUS.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(TyrannosaurusEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
