...
public class ParasaurolophusEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ParasaurolophusEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ParasaurolophusEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ParasaurolophusEntity.class, EntityDataSerializers.STRING);
	...
	public ParasaurolophusEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PrehistoricUprisingModEntities.PARASAUROLOPHUS.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "parasaurolophus");
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		ParasaurolophusEntity retval = PrehistoricUprisingModEntities.PARASAUROLOPHUS.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(PrehistoricUprisingModEntities.PARASAUROLOPHUS.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
