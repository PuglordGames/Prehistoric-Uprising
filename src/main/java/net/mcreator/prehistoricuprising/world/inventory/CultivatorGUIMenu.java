...
public class CultivatorGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CultivatorGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PrehistoricUprisingModMenus.CULTIVATOR_GUI.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			PrehistoricUprisingMod.PACKET_HANDLER.sendToServer(new CultivatorGUISlotMessage(slotid, x, y, z, ctype, meta));
			CultivatorGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof CultivatorGUIMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			CultivatorGUIWhenThisGUIIsOpenTickProcedure.execute(entity);
		}
	}
}
