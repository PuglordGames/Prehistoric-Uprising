...
import net.mcreator.prehistoricuprising.procedures.ExtractorGUIWhenTHisGUIIsOpenTickProcedure;
import net.mcreator.prehistoricuprising.network.ExtractorGUISlotMessage;
...
public class ExtractorGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ExtractorGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PrehistoricUprisingModMenus.EXTRACTOR_GUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 43, 17) {
			...
			public boolean mayPlace(ItemStack stack) {
				return stack.is(ItemTags.create(new ResourceLocation("extractor_can_extract")));
			}
		}));
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 43, 53) {
			...
			@Override
			public boolean mayPlace(ItemStack stack) {
				return PrehistoricUprisingModItems.VIAL.get() == stack.getItem();
			}
		}));
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			PrehistoricUprisingMod.PACKET_HANDLER.sendToServer(new ExtractorGUISlotMessage(slotid, x, y, z, ctype, meta));
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof ExtractorGUIMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			ExtractorGUIWhenTHisGUIIsOpenTickProcedure.execute(entity);
		}
	}
}
