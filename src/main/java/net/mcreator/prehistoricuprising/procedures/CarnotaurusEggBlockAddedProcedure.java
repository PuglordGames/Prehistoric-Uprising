...
public class CarnotaurusEggBlockAddedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		PrehistoricUprisingMod.queueServerWork(500, () -> {
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = PrehistoricUprisingModEntities.CARNOTAURUS.get().spawn(_level, BlockPos.containing(x, y, z), MobSpawnType.MOB_SUMMONED);
